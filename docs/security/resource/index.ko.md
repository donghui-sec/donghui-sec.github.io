...
<a href="korea/" class="book-card">
  <div class="book-header">
    ...
    <div class="book-title">🇰🇷 대한민국</div>
  </div>
  <div class="book-body">
    <div class="book-description">
      한국의 정보보안 기관, 기업, 언론사 등 국가별 보안 리소스를 모아놓은 공간입니다.
    </div>
    <div class="book-meta">
      <span class="book-meta-item">📊 국가별 리소스</span>
    </div>
    <div class="book-link">보기 →</div>
  </div>
</a>
...
<a href="usa/" class="book-card">
  <div class="book-header">
    ...
    <div class="book-title">🇺🇸 미국</div>
  </div>
  <div class="book-body">
    <div class="book-description">
      미국의 정보보안 기관, 기업, 연구소 등 국가별 보안 리소스를 모아놓은 공간입니다.
    </div>
    <div class="book-meta">
      <span class="book-meta-item">📊 국가별 리소스</span>
    </div>
